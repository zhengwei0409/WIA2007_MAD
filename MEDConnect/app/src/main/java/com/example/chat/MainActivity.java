...
//                        startActivity(intent);
                    ...
                    break;
                case "3": // Video Consultation
                    addDelayedResponse("Redirecting you to Video Consultation...");
                    messageHandler.postDelayed(() -> {
//                        Intent intent = new Intent(MainActivity.this, );
//                        startActivity(intent);
                    }, MESSAGE_DELAY);
    ...
    private void processDurationResponse(String userInput) {
        ...
        addResponse("Would you like to: \n1. Schedule an appointment\n2. Speak to a doctor via video consultation\n3. Get general advice from MedConnect AI");
    ...
    private void handleNextAction(String userInput) {
        switch (userInput) {
            case "1": // Schedule an Appointment
                ...
                messageHandler.postDelayed(() -> {
//                    Intent appointmentIntent = new Intent(MainActivity.this, );
//                    startActivity(appointmentIntent);
                }, MESSAGE_DELAY);
                break;
            case "2": // Video Consultation
                addDelayedResponse("Redirecting you to the Video Consultation page...");
                messageHandler.postDelayed(() -> {
//                    Intent videoConsultIntent = new Intent(MainActivity.this, );
//                    startActivity(videoConsultIntent);
                }, MESSAGE_DELAY);
                break;
            case "3": // Chat with AI
                ...
                messageHandler.postDelayed(() -> {
                    ...
                    Intent chatIntent = new Intent(MainActivity.this, ChatAI.class);
